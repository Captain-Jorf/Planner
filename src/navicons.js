...
export const navIcons = {
  ...
  // چرخ‌دنده‌ی تنظیمات
  settings: wrap(`
    <path d="M24 6.5l3 4 5-1 .5 5 4.5 2.3-2.6 4.3 2.6 4.3-4.5 2.3-.5 5-5-1-3 4-3-4-5 1-.5-5L6.9 24l2.6-4.3L6.9 15.4l4.5-2.3.5-5 5 1z"
      fill="#9b59f6"/>
    <circle cx="24" cy="24" r="7" fill="#2ba8f5"/>
    <circle cx="24" cy="24" r="3" fill="#ffc531" stroke="none"/>
  `),
}
